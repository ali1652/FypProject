...
public class userRequestCard extends ArrayAdapter<requestFormClass> {
    ...
    public userRequestCard(Context context, List<requestFormClass> requestList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.userrequestcard, parent, false);
