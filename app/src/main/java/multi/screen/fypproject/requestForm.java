...
public class requestForm extends AppCompatActivity {
    ...
    private void setupFoodItemSpinner(String category){
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<>(requestForm.this, android.R.layout.simple_spinner_item, foodItems);
                adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    ...
    public void addRequest(View view) {
        ...
        Toast.makeText(this, "Request and Appointment made", Toast.LENGTH_SHORT).show();
    }
}